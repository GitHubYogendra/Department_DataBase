...
public class FacultyTable extends AppCompatActivity {
    ListView listView1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_faculty_table);
        ...
        listView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(FacultyTable.this, EditorFaculty.class);
                ...
                Toast.makeText(FacultyTable.this, ListViewClickData.getFname(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void DisplayDataInToListView() {
        ...
        listAdapter1 = new list1(FacultyTable.this, R.layout.custom2, FacultyList);
